...
3. El pipeline ejecuta cuatro pasos:
   ...
   2. **Embeddings** — los chunks se vectorizan con OpenAI `text-embedding-3-small` (1536 dimensiones), por lotes.
...
| **`embedding.service.js`** | Genera los vectores con OpenAI (`text-embedding-3-small`, 1536 dims) en lotes de 100, informando el avance mediante callback para que el job refleje el progreso. |
